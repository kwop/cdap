...
public interface SQLEngine<KEY_IN, VALUE_IN, KEY_OUT, VALUE_OUT> extends PipelineConfigurable,
   ...
   *
   * @param pushRequest the request containing information about the dataset name and schema. t@return an {@link
   *                    OutputFormatProvider} instance that can be used to write records to the SQL Engine into the
   *                    specified dataset.
   */
   ...
   * @return the {@link SQLOperationResult} instance with information about the execution of this
   *                              task.
   */
